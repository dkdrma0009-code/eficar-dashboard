...
const TYPE_META: Record<LibraryContentType, { label: string; emoji: string; color: string; bg: string }> = {
  ...
  sms:      { label: 'SMS',         emoji: '📱', color: '#005957', bg: '#E6F2F2' },
  lms:      { label: 'LMS',         emoji: '📄', color: '#0A66C2', bg: '#EFF6FF' },
  mms:      { label: 'MMS',         emoji: '🖼️', color: '#7C3AED', bg: '#EDE9FE' },
};

const ALL_TYPES: LibraryContentType[] = ['linkedin', 'kakao', 'email', 'sms', 'lms', 'mms', 'card', 'cardnews'];
